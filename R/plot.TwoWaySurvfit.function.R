...
plot(grid.t,alpha.t.Baseline,xlab="Duration time (t)",ylab="",
     cex=0.5,main="Baseline",ylim=range(c(alpha.t.Baseline-deviation.t.Baseline,alpha.t.Baseline+deviation.t.Baseline)),...)
...
plot(grid.b,alpha.b.Baseline,xlab="Entry time (b)",ylab="",cex=0.5,main="Baseline",axes=TRUE,
  ylim=range(c(alpha.b.Baseline-deviation.b.Baseline,alpha.b.Baseline+deviation.b.Baseline)),...)
...
{
#plot.t
plot(grid.t,get(paste("alpha.t.",factor.names[k],sep="")),xlab="Duration time (t)",ylab="",cex=0.5,
   main=factor.names[k],ylim=y.range,...)
...
#plot.b
plot(grid.b,get(paste("alpha.b.",factor.names[k],sep="")),xlab="Entry time (b)",ylab="",cex=0.5,
   main=factor.names[k],axes=TRUE,ylim=y.range,...)
